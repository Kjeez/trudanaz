    ...
    <section className="bg-cream">
      <div className="site-container py-10 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          {/* Product image */}
          <div className="bg-product-bed rounded-[var(--radius-panel)] p-6 md:p-10 flex items-center justify-center min-h-[320px]">
            {hasImage ? (
              <Image
                src={product.image}
              ...
              <div className="text-center text-muted">
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="mx-auto mb-3 opacity-30" aria-hidden="true">
          ...
          <div>
            ...
            <p className="text-body text-lg mb-8">{product.tagline}</p>
            ...
            {/* Caution notice */}
            {product.caution && (
              <div className="mt-8 bg-pink-hero/60 border border-pink-hero rounded-[var(--radius-card)] p-5">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Link
                href="/products"
                className="inline-flex items-center justify-center border-2 border-ink/20 hover:border-ink text-ink font-bold px-7 py-3.5 rounded-full transition-colors text-sm"
              >
                ← Back to Products
              </Link>
            </div>
...
function DetailRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="border-b border-cream-alt pb-4">
      <dt className="text-xs font-bold uppercase tracking-wider text-muted mb-1">
        {label}
      </dt>
      <dd className="text-body text-[15px] leading-relaxed">{value}</dd>
    </div>
  );
}
